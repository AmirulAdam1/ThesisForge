    ...
    <div>
        <div class="flex justify-between items-center my-4 mx-8">
            <div class="w-4/6 dark:text-white">
                <h1 class="text-lg lg:text-xl font-bold">Your Expert List</h1>
                <p class="text-sm lg:text-base">A list of your experts in ThesisForge system including their name, email and domain.</p>
            </div>
            <a href="<?php echo e(route('experts.addOwnExpert')); ?>" class="text-white text-sm lg:text-base bg-blue-600 px-4 py-2 rounded-lg font-semibold hover:bg-blue-800">
                Add Expert
            </a>
        </div>
    </div>
                    ...
                    <tr class="border-gray-30 h-auto cursor-pointer" data-href="http://www.google.com/">
                        <td class="w-full h-full sm:w-auto max-w-0 sm:max-w-none px-2 py-4 border-t border-b border-gray-300 sm:text-sm md:text-lg font-medium whitespace-nowrap truncate">
                                ...
                                <dl class="lg:hidden sm:text-xs md:text-base font-normal">
                                    ...
                                    <dt class="sr-only sm:hidden">Domain</dt>
                        ...
                        <td class="h-full px-2 py-4 border-t border-b border-gray-300 sm:text-xs md:text-lg font-medium whitespace-nowrap w-72">
                            <div class="flex items-start flex-col lg:flex-row gap-2">
                                <a href="<?php echo e(route('experts.view-expert', $expert)); ?>" class="lg:mx-2">
...
<?php endif; ?><?php /**PATH C:\Users\Adam\Downloads\WisdomWare-main\resources\views/experts/viewOwnExpert.blade.php ENDPATH**/ ?>