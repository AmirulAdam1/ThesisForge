...
<?php endif; ?>
    ...
    <div class="flex justify-center items-center">
        <img class="w-48 h-48" src="images/my-image.png" alt="">
    </div>
    <header class="text-center">
        ...
        <p class="mb-4 dark:text-white">Log in to ThesisForge</p>
    </header>
...
<?php endif; ?>
<?php /**PATH C:\Users\Adam\Downloads\WisdomWare-main\resources\views/auth/login.blade.php ENDPATH**/ ?>