            ...
            x-bind:class="{'w-64':$store.sidebar.full, 'w-0':!$store.sidebar.full,'top-0 left-0':$store.sidebar.navOpen,'top-0 -left-64 sm:left-0':!$store.sidebar.navOpen}">
                    ...
                    class="relative">
                        ...
                        <div x-cloak x-show="open"
                             ...
                             x-bind:class="$store.sidebar.full ? expandedClass : shrinkedClass"
                             class="text-gray-400 space-y-3 ">
                            <a class="hover:text-gray-200 cursor-pointer block">View Own Expert</a>
                            <a href="<?php echo e(route('experts.viewAllExpert')); ?>" class="hover:text-gray-200 cursor-pointer block">View All Expert</a>
...
<?php /**PATH C:\xampp\htdocs\WisdomWare\resources\views/layouts/app.blade.php ENDPATH**/ ?>